...
exports.Checkout = class Checkout {
  ...
  constructor(page) {
    ...
    this.backPackProductPageLink = this.page.
    this.backPackItem = {
  ...
  async verifyThatUsersCanCheckoutSuccessfully() {
  ...
  async function verifyItem() {
    await expect(this.cartItemName).toContainText(this.backPackItem.itemName);
    await expect(this.cartItemDescription).toContainText(
  ...
  async function checkOutFromProductPage() {
