...
async function getImageUrl(page) {
      const xpathExpression = '//img[@alt="Sauce Labs Backpack"]'; // Replace with your actual XPath expression
      const element = await page.$(xpathExpression);

      // await expect(imageElement).toContain("/static/media/sl-404.168b1cce.jpg");
}
...
test('Login with problem user', async ({ page }) => {
      ...
      // await console.log(getImageUrl(page));
