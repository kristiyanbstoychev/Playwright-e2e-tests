...
test('Login with problem user', async ({ page }) => {
      ...
      const imageAltAttribute = await page.$(`img[alt="Sauce Labs Backpack"]`);
      // console.log(imageAltAttribute.getAttribute("src"))
      // await expect(imageAltAttribute.getAttribute("src")).toContain(
