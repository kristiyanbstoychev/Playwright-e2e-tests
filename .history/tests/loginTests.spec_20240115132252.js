...
test('Login with problem user', async ({ page }) => {
      ...
      const productImage = await elementHandle.evaluate((element) => {
        // Replace 'your-attribute' with the actual attribute name you want to retrieve
        return element.getAttribute("your-attribute");
      });
